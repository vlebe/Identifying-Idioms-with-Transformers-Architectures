...
from dataset import MWEDatasetEmbedding
from transformer import BertMWEEmbedding
...
def main(args):
    ...
    train_dataset = MWEDatasetEmbedding(f"train_{args.output_encoding}.csv", tokenizer, "train_embeddings.pt")
    train_loader = DataLoader(train_dataset, batch_size=args.batch_size)

    val_dataset = MWEDatasetEmbedding(f"val_{args.output_encoding}.csv", tokenizer, "val_embeddings.pt")
    val_loader = DataLoader(val_dataset, batch_size=args.batch_size)

    test_dataset = MWEDatasetEmbedding(f"test_{args.output_encoding}.csv", tokenizer, "test_embeddings.pt")
    test_loader = DataLoader(test_dataset, batch_size=args.batch_size)
    
    model = BertMWEEmbedding(args.n_classes, device)
    model.to(device)
